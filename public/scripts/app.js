...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Opportunity = __webpack_require__(233);
	
	var _Opportunity2 = _interopRequireDefault(_Opportunity);
	
	var _OpportunityAddEdit = __webpack_require__(234);
	
	var _OpportunityAddEdit2 = _interopRequireDefault(_OpportunityAddEdit);
	
	var _Opportunities = __webpack_require__(235);
	
	var _Opportunities2 = _interopRequireDefault(_Opportunities);
	
	var _reactRouter = __webpack_require__(176);
	
	var _baobabReact = __webpack_require__(169);
	
	var _baobabReact2 = _interopRequireDefault(_baobabReact);
	...
	var Main = (_dec = root(_state2.default), _dec(_class = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.Route, { path: '/', component: _Opportunities2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/m', component: _OpportunityAddEdit2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/v', component: _Opportunity2.default })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baobab = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _emmett = __webpack_require__(162);
	
	var _emmett2 = _interopRequireDefault(_emmett);
	
	var _cursor = __webpack_require__(163);
	
	var _cursor2 = _interopRequireDefault(_cursor);
	
	var _monkey = __webpack_require__(164);
	
	var _watcher = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  decorators: __webpack_require__(174),
	  higherOrder: __webpack_require__(170),
	  mixins: __webpack_require__(173),
	  PropTypes: __webpack_require__(172),
	  wrappers: __webpack_require__(175)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsHelpersJs = __webpack_require__(171);
	
	var _utilsPropTypesJs = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PropTypes = __webpack_require__(172),
	    helpers = __webpack_require__(171),
	    makeError = __webpack_require__(161).helpers.makeError;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _higherOrderJs = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Opportunity = (_dec = root(_state2.default), _dec2 = branch({
	  ...
	  function Opportunity() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Opportunity).call(this));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OpportunityAddEdit = (_dec = root(_state2.default), _dec2 = branch({
	  ...
	  function OpportunityAddEdit() {
	    _classCallCheck(this, OpportunityAddEdit);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OpportunityAddEdit).call(this));
	
	    _this.db = new Firebase('https://glowing-fire-7199.firebaseio.com/items/');
	    _this.db.limitToLast(25).on("child_added", function (child) {
	      _state2.default.select('items').push(child.val());
	    });
	    return _this;
	  }
	
	  _createClass(OpportunityAddEdit, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {}
	  }, {
	    key: 'onAdd',
	    value: function onAdd() {
	      var value = _reactDom2.default.findDOMNode(this.refs.textInput).value.trim();
	      this.db.push(value);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.renderItems(),
	        _react2.default.createElement('input', { ref: 'textInput' }),
	        _react2.default.createElement(
	          'button',
